...
To generate a new feature, run the following command:

```bash
$ yarn run feat:generate <feature-name>
```

Replace `<feature-name>` with the name of the feature you want to generate. This command will create a new module,
controller, service, entity, and dto for the feature you specify.

After running the command, you will need to add the new module to the `app.module.ts` file.
```typescript
import { FeatureNameModule } from './models/feature-name/feature-name.module';

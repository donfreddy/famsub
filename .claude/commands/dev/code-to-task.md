...
This command scans your codebase for TODO/FIXME comments, technical debt markers, deprecated code, and other indicators
that should be tracked as tasks. It automatically creates organized, prioritized Linear tasks to ensure important code
...
Search for common patterns indicating necessary work:

```bash
# Find TODO comments
rg "TODO|FIXME|HACK|XXX|OPTIMIZE|REFACTOR" --type-add 'code:*.{js,ts}' -t code
...
Create an overview of findings:
...
https://linear.app/flexypush/project/flexypush-ea07d597650b
```
